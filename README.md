...
The code can also check against adlibris prices if you don't want to pay more than for a new book.
...
3. In this directory, run "python find_books.py". Additional flags: --bookshelf, --max_price, --columns, --check_adlibris.
